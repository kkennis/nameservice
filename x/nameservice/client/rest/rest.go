...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router) {
		...
		r.HandleFunc("/nameservice/name", buyNameHandler(cliCtx)).Methods("POST")
		...
		r.HandleFunc("/nameservice/name/{key}/resolve", resolveNameHandler(cliCtx, "nameservice")).Methods("GET")
